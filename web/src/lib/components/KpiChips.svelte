...
<div class="flex border-y mt-4 text-center" style="border-color:var(--divider)" aria-label="Key figures">
  <div class="flex-1 py-2 border-r" style="border-color:var(--divider)">
    ...
    <small class="text-[8px] uppercase font-bold" style="color:var(--muted)">cashback</small>
  </div>
  <div class="flex-1 py-2 border-r" style="border-color:var(--divider)">
    <b class="block text-base font-extrabold tnum">{rm(committedMonthly)}</b>
    <small class="text-[8px] uppercase font-bold" style="color:var(--muted)">committed/mo</small>
  </div>
  <div class="flex-1 py-2">
    ...
    >{delta > 0 ? '+' : ''}{rm(delta)}</b>
    <small class="text-[8px] uppercase font-bold" style="color:var(--muted)">vs {prev ?? '—'}</small>
  </div>
</div>
