...
# NOT dashboard-only: export_data.py ships this whole dict to the PWA as app.json's
# "icons", which is where web/src/lib/components/Icon.svelte reads its paths from. An
# icon added for the PWA belongs here, and only reaches prod when the pipeline reruns.
MDI = {
    ...
    # #64: the Bills-due reminder toggle (PWA only — the standalone dashboard has no bills).
    ...
    "bell-ring": "M21,19V20H3V19L5,17V11C5,7.9 7.03,5.17 10,4.29C10,4.19 10,4.1 10,4A2,2 0 0,1 12,2A2,2 0 0,1 14,4C14,4.1 14,4.19 14,4.29C16.97,5.17 19,7.9 19,11V17L21,19M14,21A2,2 0 0,1 12,23A2,2 0 0,1 10,21M19.75,3.19L18.33,4.61C20.04,6.3 21,8.6 21,11H23C23,8.07 21.84,5.25 19.75,3.19M1,11H3C3,8.6 3.96,6.3 5.67,4.61L4.25,3.19C2.16,5.25 1,8.07 1,11Z",
    "percent": "M18.5,3.5L3.5,18.5L5,20L20,5M7,4A3,3 0 0,1 10,7A3,3 0 0,1 7,10A3,3 0 0,1 4,7A3,3 0 0,1 7,4M7,6A1,1 0 0,0 6,7A1,1 0 0,0 7,8A1,1 0 0,0 8,7A1,1 0 0,0 7,6M17,14A3,3 0 0,1 20,17A3,3 0 0,1 17,20A3,3 0 0,1 14,17A3,3 0 0,1 17,14M17,16A1,1 0 0,0 16,17A1,1 0 0,0 17,18A1,1 0 0,0 18,17A1,1 0 0,0 17,16Z",    # #66: the Settings control (PWA only — BottomNav tab + TopBar icon button).
