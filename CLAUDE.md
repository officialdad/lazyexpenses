...
python test_web_push.py               # plain-assert tests for web_push.py (RFC 8291 test vector byte-for-byte, VAPID JWT signature verified with the public key, 410 drops the subscription, the two-transport fan-out; prints OK)
